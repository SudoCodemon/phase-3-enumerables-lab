...
def print_spiciest_foods(spicy_foods)
  # your code here
  higher_than_5 = spiciest_foods(spicy_foods)
  print_spicy_foods(higher_than_5)
end
...
def average_heat_level(spicy_foods)
  ...
  all_heat_levels = 0
  spicy_foods.each do |food|
    all_heat_levels += food[:heat_level]
  end
  all_heat_levels / spicy_foods.length
end
